...
public enum SuperNodeType: Codable, Hashable {
    case cloudPrivate
    case cloudPublic
    case web
    case root
    ...
    public init(from decoder: Decoder) throws {
        ...
        if let type = SuperNodeType(rawValue: rawValue) {
            self = type
        } else {
...
extension SuperNodeType: CaseIterable {
    public static var allCases: [SuperNodeType] {
        return [
            .root,
            .doc,
            .heading,
...
extension SuperNodeType: RawRepresentable {
